...
INSERT INTO public.food_catalog (name, kcal, protein, fat, carbs, category, portion_default_g, cost_per_100g, ingredients) VALUES

-- ── Завтраки ─────────────────────────────────────────────────────────
('Овсяная каша на молоке', 130.0, 4.5, 3.8, 19.5, 'breakfast', 250, 8.0,
...
('Омлет с помидорами', 145.0, 10.5, 10.2, 3.5, 'breakfast', 180, 22.0,
...
('Творог со сметаной', 160.0, 15.0, 9.5, 4.5, 'breakfast', 200, 30.0,
...
('Гречневая каша с маслом', 142.0, 4.8, 4.2, 22.0, 'breakfast', 200, 10.0,
...
('Яичница с беконом', 280.0, 16.5, 22.5, 1.5, 'breakfast', 150, 45.0,
...
('Сырники со сметаной', 220.0, 13.5, 8.5, 24.0, 'breakfast', 200, 35.0,
...
('Блины на молоке', 210.0, 6.5, 7.5, 30.0, 'breakfast', 200, 18.0,
...
('Бутерброд с сыром и маслом', 310.0, 12.0, 18.5, 26.0, 'breakfast', 120, 40.0,
...
('Мюсли с йогуртом', 195.0, 7.5, 4.5, 32.0, 'breakfast', 200, 35.0,
...
('Пшённая каша на молоке', 135.0, 4.8, 3.5, 22.0, 'breakfast', 250, 9.0,
...
-- ── Основные блюда ────────────────────────────────────────────────────
('Котлеты домашние', 220.0, 14.6, 14.1, 9.0, 'main', 200, 55.0,
...
('Куриное филе запечённое', 165.0, 28.5, 5.5, 1.5, 'main', 200, 60.0,
...
('Говядина тушёная с луком', 235.0, 24.5, 14.0, 5.0, 'main', 200, 95.0,
...
('Свинина с картошкой в духовке', 285.0, 18.5, 16.5, 17.0, 'main', 250, 75.0,
...
('Пельмени со сметаной', 265.0, 11.5, 11.0, 29.5, 'main', 300, 65.0,
...
('Рыба жареная', 175.0, 19.5, 9.5, 4.5, 'main', 200, 70.0,
...
('Куриные бёдра тушёные', 215.0, 20.5, 13.5, 3.0, 'main', 220, 55.0,
...
('Макароны по-флотски', 240.0, 16.5, 10.5, 22.0, 'main', 250, 45.0,
...
('Лосось запечённый с лимоном', 208.0, 20.0, 13.5, 0.5, 'main', 200, 160.0,
...
('Тефтели в томатном соусе', 175.0, 12.5, 9.5, 10.5, 'main', 250, 50.0,
...
-- ── Гарниры ──────────────────────────────────────────────────────────
('Гречка варёная', 110.0, 4.2, 1.1, 21.3, 'side', 200, 12.0,
 '[{"name":"гречка","category":"grain","qty":80,"unit":"г"},{"name":"масло сливочное","category":"condiment","qty":10,"unit":"г"},{"name":"соль","category":"condiment","qty":1,"unit":"щепотка"}]'),

('Рис белый варёный', 130.0, 2.7, 0.3, 28.0, 'side', 200, 10.0,
...
('Картофельное пюре', 115.0, 2.5, 4.5, 16.5, 'side', 200, 18.0,
...
('Макароны варёные', 138.0, 4.7, 0.7, 27.5, 'side', 200, 15.0,
...
('Капуста тушёная', 75.0, 2.5, 4.5, 7.0, 'side', 200, 20.0,
...
('Перловая каша', 109.0, 3.1, 0.4, 22.2, 'side', 200, 8.0,
...
('Брокколи на пару', 35.0, 2.8, 0.4, 4.3, 'side', 200, 35.0,
...
('Тушёные кабачки', 55.0, 1.5, 2.5, 6.5, 'side', 200, 15.0,
...
('Чечевица варёная', 116.0, 7.8, 0.6, 20.0, 'side', 200, 18.0,
...
('Картофель запечённый', 105.0, 2.8, 2.5, 18.5, 'side', 200, 12.0,
...
-- ── Салаты ───────────────────────────────────────────────────────────
('Салат из огурцов и помидоров', 42.0, 1.2, 2.5, 3.8, 'salad', 180, 30.0,
...
('Салат греческий', 115.0, 3.5, 9.5, 5.0, 'salad', 200, 65.0,
...
('Салат Оливье', 198.0, 7.5, 14.5, 11.0, 'salad', 200, 45.0,
...
('Морковный салат с чесноком', 85.0, 1.5, 5.5, 7.5, 'salad', 150, 15.0,
...
('Винегрет', 75.0, 1.7, 3.5, 9.0, 'salad', 200, 20.0,
...
('Салат из капусты', 48.0, 1.5, 2.0, 6.5, 'salad', 180, 12.0,
...
('Салат Цезарь с курицей', 185.0, 16.5, 11.5, 6.5, 'salad', 200, 80.0,
...
('Свекольный салат с орехами', 145.0, 3.5, 8.5, 14.5, 'salad', 150, 35.0,
...
('Салат из тунца', 135.0, 14.5, 7.0, 4.0, 'salad', 180, 75.0,
...
('Дачный салат', 55.0, 1.8, 3.0, 5.5, 'salad', 180, 25.0,
...
-- ── Перекусы ─────────────────────────────────────────────────────────
('Творог с фруктами', 130.0, 14.5, 3.5, 11.0, 'snack', 200, 40.0,
...
('Йогурт с мюсли', 185.0, 7.5, 4.5, 30.0, 'snack', 200, 40.0,
...
('Бутерброд с авокадо', 220.0, 4.5, 12.5, 23.5, 'snack', 120, 60.0,
...
('Варёное яйцо', 155.0, 12.9, 11.5, 0.7, 'snack', 100, 15.0,
 '[{"name":"яйца","category":"dairy","qty":2,"unit":"шт"},{"name":"соль","category":"condiment","qty":1,"unit":"щепотка"}]'),

('Фруктовый салат', 75.0, 1.0, 0.5, 17.0, 'snack', 200, 45.0,
...
('Сыр с виноградом', 215.0, 9.5, 15.0, 11.5, 'snack', 100, 65.0,
