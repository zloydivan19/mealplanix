...
export type CustomDishData = Omit<Dish, 'id' | 'photo' | 'portion_min_g' | 'portion_max_g' | '_custom'>;
...
export interface Database {
  public: {
    Tables: {
      ...
      menu_plans: {
        Row: MenuPlan;
        Insert: Omit<MenuPlan, 'id'>;
        Update: Partial<Omit<MenuPlan, 'id'>>;
      };
      custom_dishes: {
        Row: CustomDish;
        Insert: Omit<CustomDish, 'id' | 'created_at'>;
        Update: Partial<Omit<CustomDish, 'id'>>;
      };
      custom_products: {
        Row: CustomProduct;
        Insert: Omit<CustomProduct, 'id' | 'created_at'>;
        Update: Partial<Omit<CustomProduct, 'id'>>;
      };
      household_fridge: {
        Row: FridgeRow;
        Insert: Omit<FridgeRow, 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Omit<FridgeRow, 'id' | 'household_id' | 'created_at'>>;
      };
      household_join_requests: {
        Row: HouseholdJoinRequest;
        Insert: Omit<HouseholdJoinRequest, 'id' | 'created_at'>;
        Update: Partial<Omit<HouseholdJoinRequest, 'id'>>;
      };
    };
  };
}
